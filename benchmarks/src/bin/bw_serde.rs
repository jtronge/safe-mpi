use benchmarks::{
    data_controllers::{
        wait_all, BincodeController, MessagePackController, PostcardController, SerdeController,
        SerdeScope,
    },
    BandwidthOptions, SerKind, SerdeArgs,
};
use clap::Parser;
...
fn serde_bw<T, P, S>(opts: BandwidthOptions, rank: usize, comm: S, prepare: P) -> Vec<(usize, f32)>
where

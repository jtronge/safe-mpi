...
///
/// TODO: Need to think about global state and how it can be used with progress
/// functions, as well as how to implement a proper progress function that can
/// work with something such as a "wait_all" operation.
pub trait Provider {
